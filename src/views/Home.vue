<template>
  <div class="container text-center">
    <img class="img-fluid main-img rounded" src="../assets/pool-logo.svg" />
    ...
    >
      <span>Not eligible for buying</span>
    </button>
    ...
    <div class="row mt-5" v-if="!isSamePrice">
...
export default {
  ...
  computed: {
    ...
    isSamePrice() {
      // check if domains have the same price no matter the length
      if (
        this.getMinterTldPrice1 == this.getMinterTldPrice2 && 
        this.getMinterTldPrice1 == this.getMinterTldPrice3 &&
        this.getMinterTldPrice1 == this.getMinterTldPrice4 &&
        this.getMinterTldPrice1 == this.getMinterTldPrice5
        ) 
      {
        return true;
      }
