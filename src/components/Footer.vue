<template>
  <div class="container-fluid text-center mt-3">
    ...
    <a target="_blank" href="https://pooltogether.com/">Operated by the PoolTogether DAO</a> | 
  ...
  <div class="container-fluid text-center">
    ...
    <a class="icons" target="_blank" href="https://pooltogether.com/discord"><i class="bi bi-discord"></i></a>

    <a class="icons" target="_blank" href="https://twitter.com/PoolTogether_"><i class="bi bi-twitter"></i></a>

    <a class="icons" href="https://medium.com/pooltogether" target="_blank"><i class="bi bi-pencil-square"></i></a>
